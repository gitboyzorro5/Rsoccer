...
###############################################################################
df <- tail(I1_ucl[I1_ucl$HomeTeam =="Juventus" | I1_ucl$AwayTeam =="Juventus",],6)
df2 <- tail(D1_ucl[D1_ucl$HomeTeam == "Freiburg" | D1_ucl$AwayTeam == "Freiburg",],6)
...
write.csv(temp_analysis,'juvfrei6.csv')
