...
#E0
E0_spread <- subset(readxl::read_excel('UCL20252026.xlsx'), Div == "E0")
...
#I1
I1_spread <- subset(readxl::read_excel('UCL20252026.xlsx'), Div == "I1")
...
#SP1
SP1_spread <- subset(readxl::read_excel('UCL20252026.xlsx'), Div == "SP1")
...
#F1
F1_spread <- subset(readxl::read_excel('UCL20252026.xlsx'), Div == "F1")
...
#B1
B1_spread <- subset(allteams20252026,Div =="B1")
...
###############################################################################################################
#D2
D2_spread <- subset(allteams20252026,Div =="D2")
...
###############################################################################################################
E1_spread <- subset(allteams20252026,Div =="E1")
...
#############################################################################################################################################
E2_spread <- subset(allteams20252026,Div =="E2")
...
#############################################################################################################################################
E3_spread <- subset(allteams20252026,Div =="E3")
...
########################################################################################################################################
EC_spread <- subset(allteams20252026,Div =="EC")
...
########################################################################################################################################
F2_spread <- subset(allteams20252026,Div =="F2")
...
################################################################################################################################################
#G1
G1_spread <- subset(allteams20252026,Div =="G1")
...
############################################################################################################################################
#I2
I2_spread <- subset(allteams20252026,Div =="I2")
...
############################################################################################################################################
N1_spread <- subset(allteams20252026,Div =="N1")
...
###########################################################################################################################################
P1_spread <- subset(allteams20252026,Div =="P1")
...
########################################################################################################################################
#SC0
SC0_spread <- subset(allteams20252026,Div =="SC0")
...
########################################################################################################################################
SC1_spread <- subset(allteams20252026,Div =="SC1")
...
###################################################################################################################################################
#SC2
SC2_spread <- subset(allteams20252026,Div =="SC2")
...
##################################################################################################################################################
#SC3
SC3_spread <- subset(allteams20252026,Div =="SC3")
...
##################################################################################################################################################
#SP2
SP2_spread <- subset(allteams20252026,Div =="SP2")
...
##################################################################################################################################################
T1_spread <- subset(allteams20252026,Div =="T1")
