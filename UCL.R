...
###############################################################################
df <- SP1_ucl[SP1_ucl$HomeTeam =="Real Madrid" | SP1_ucl$AwayTeam =="Real Madrid",]
df2 <- SP1_ucl[SP1_ucl$HomeTeam == "Barcelona" | SP1_ucl$AwayTeam == "Barcelona",]
...
write.csv(temp_analysis,'elclassicoall.csv')
