...
#read the data
B1_schedule20212022 <- read.csv('../../../Leonard.000/Downloads/B1_schedule20212022.csv')
D1_schedule20212022 <- read.csv('../../../Leonard.000/Downloads/D1_schedule20212022.csv')
D2_schedule20212022 <- read.csv('../../../Leonard.000/Downloads/D2_schedule20212022.csv')
E0_schedule20212022 <- read.csv('../../../Leonard.000/Downloads/E0_schedule20212022.csv')
E1_schedule20212022 <- read.csv('../../../Leonard.000/Downloads/E1_schedule20212022.csv')
E2_schedule20212022 <- read.csv('../../../Leonard.000/Downloads/E2_schedule20212022.csv')
E3_schedule20212022 <- read.csv('../../../Leonard.000/Downloads/E3_schedule20212022.csv')
EC_schedule20212022 <- read.csv('../../../Leonard.000/Downloads/EC_schedule20212022.csv')
F1_schedule20212022 <- read.csv('../../../Leonard.000/Downloads/F1_schedule20212022.csv')
F2_schedule20212022 <- read.csv('../../../Leonard.000/Downloads/F2_schedule20212022.csv')
UCL_schedule20212022 <- read.csv('../../../Leonard.000/Downloads/UCL_schedule20212022.csv')
I1_schedule20212022 <- read.csv('../../../Leonard.000/Downloads/I1_schedule20212022.csv')
N1_schedule20212022 <- read.csv('../../../Leonard.000/Downloads/N1_schedule20212022.csv')
P1_schedule20212022 <- read.csv('../../../Leonard.000/Downloads/P1_schedule20212022.csv')
SC0_schedule20212022 <- read.csv('../../../Leonard.000/Downloads/SC0_schedule20212022.csv')
SC1_schedule20212022 <- read.csv('../../../Leonard.000/Downloads/SC1_schedule20212022.csv')
SP1_schedule20212022 <- read.csv('../../../Leonard.000/Downloads/SP1_schedule20212022.csv')
SP2_schedule20212022 <- read.csv('../../../Leonard.000/Downloads/SP2_schedule20212022.csv')
T1_schedule20212022 <- read.csv('../../../Leonard.000/Downloads/T1_schedule20212022.csv')
UEL_schedule20212022 <- read.csv('../../../Leonard.000/Downloads/UEL_schedule20212022.csv')
#parse the dates
...
myfixtures <- all_schedule20212022[all_schedule20212022$Date >= '2021-09-24' & all_schedule20212022$Date <= '2021-09-28',]
