...
#parse the dates
#B1_schedule20232024$Date <- mdy(B1_schedule20232024$Date)
D1_schedule20232024$Date <- dmy(D1_schedule20232024$Date)
#D2_schedule20232024$Date <- mdy(D2_schedule20232024$Date)
E0_schedule20232024$Date <- dmy(E0_schedule20232024$Date)
E1_schedule20232024$Date <- dmy(E1_schedule20232024$Date)
#E2_schedule20232024$Date <- mdy(E2_schedule20232024$Date)
#E3_schedule20232024$Date <- mdy(E3_schedule20232024$Date)
#EC_schedule20232024$Date <- mdy(EC_schedule20232024$Date)
F1_schedule20232024$Date <- dmy(F1_schedule20232024$Date)
#F2_schedule20232024$Date <- mdy(F2_schedule20232024$Date)
...
#P1_schedule20232024$Date <- mdy(P1_schedule20232024$Date)
#SC0_schedule20232024$Date <- mdy(SC0_schedule20232024$Date)
#SC1_schedule20232024$Date <- mdy(SC1_schedule20232024$Date)
SP1_schedule20232024$Date <- dmy(SP1_schedule20232024$Date)
#SP2_schedule20232024$Date <- mdy(SP2_schedule20232024$Date)
...
#bind the fixtures
all_schedule20232024 <- rbind(D1_schedule20232024,E0_schedule20232024,E1_schedule20232024,F1_schedule20232024,I1_schedule20232024,N1_schedule20232024,SP1_schedule20232024,T1_schedule20232024)

all_schedule20232024 <- all_schedule20232024[,c(7,5,6,3)]

myfixtures <- all_schedule20232024[all_schedule20232024$Date >= '2023-08-10' & all_schedule20232024$Date <= '2023-08-14',]
