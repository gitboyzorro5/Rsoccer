...
d1_cornertotalsv2 <- tapply(D1$TC, D1[c("HomeTeam", "AwayTeam")],mean)
...
#B1
b1_hcototals <- rowSums(b1_cornertotalsv2, na.rm = T)
b1_acototals <- colSums(b1_cornertotalsv2, na.rm = T)
#D1
d1_hcototals <- rowSums(d1_cornertotalsv2, na.rm = T)
d1_acototals <- colSums(d1_cornertotalsv2, na.rm = T)
#D2
...
b1_cornertotalsv2 <- cbind(b1_cornertotalsv2,b1_hcototals,b1_acototals)
d1_cornertotalsv2 <- cbind(d1_cornertotalsv2,d1_hcototals,d1_acototals)
...
#add total corners
b1_totalcorners <- b1_hcototals + b1_acototals
d1_totalcorners <- d1_hcototals + d1_acototals
...
b1_cornertotalsv2 <- cbind(b1_cornertotalsv2,b1_totalcorners)
d1_cornertotalsv2 <- cbind(d1_cornertotalsv2,d1_totalcorners)
...
b1_cornertotalsv2 <- cbind(b1_cornertotalsv2,b1_games_played)
d1_cornertotalsv2 <- cbind(d1_cornertotalsv2,d1_games_played)
...
b1_avg_totalcorners <- round((b1_totalcorners/ b1_games_played), digits = 4)
d1_avg_totalcorners <- round((d1_totalcorners/ d1_games_played), digits = 4)
...
#Remove NA values
b1_cornertotalsv2[is.na(b1_cornertotalsv2)] <- ""
d1_cornertotalsv2[is.na(d1_cornertotalsv2)] <- ""
...
b1_cornertotalsv2 <- cbind(b1_cornertotalsv2,b1_avg_totalcorners)
d1_cornertotalsv2 <- cbind(d1_cornertotalsv2,d1_avg_totalcorners)
...
# write.xlsx(b1_cornertotalsv2,'GoalTotalsV2.xlsx',sheetName = "B1")
# write.xlsx(d1_cornertotalsv2,'GoalTotalsV2.xlsx',sheetName = "D1", append = TRUE)
# write.xlsx(d2_cornertotalsv2,'GoalTotalsV2.xlsx',sheetName = "D2", append = TRUE)
# write.xlsx(e0_cornertotalsv2,'GoalTotalsV2.xlsx',sheetName = "E0", append = TRUE)
#write.xlsx(e1_cornertotalsv2,'cornertotals.xlsx',sheetName = "E1", append = TRUE)
# write.xlsx(e2_cornertotalsv2,'GoalTotalsV2.xlsx',sheetName = "E2", append = TRUE)
# write.xlsx(e3_cornertotalsv2,'GoalTotalsV2.xlsx',sheetName = "E3", append = TRUE)
# write.xlsx(ec_cornertotalsv2,'GoalTotalsV2.xlsx',sheetName = "EC", append = TRUE)
# write.xlsx(f1_cornertotalsv2,'GoalTotalsV2.xlsx',sheetName = "F1", append = TRUE)
# write.xlsx(f2_cornertotalsv2,'GoalTotalsV2.xlsx',sheetName = "F2", append = TRUE)
# write.xlsx(g1_cornertotalsv2,'GoalTotalsV2.xlsx',sheetName = "G1", append = TRUE)
# write.xlsx(i1_cornertotalsv2,'GoalTotalsV2.xlsx',sheetName = "I1", append = TRUE)
# write.xlsx(i2_cornertotalsv2,'GoalTotalsV2.xlsx',sheetName = "I2", append = TRUE)
# write.xlsx(n1_cornertotalsv2,'GoalTotalsV2.xlsx',sheetName = "N1", append = TRUE)
# write.xlsx(p1_cornertotalsv2,'GoalTotalsV2.xlsx',sheetName = "P1", append = TRUE)
# write.xlsx(sc0_cornertotalsv2,'GoalTotalsV2.xlsx',sheetName = "SC0", append = TRUE)
# write.xlsx(sc1_cornertotalsv2,'GoalTotalsV2.xlsx',sheetName = "SC1", append = TRUE)
# write.xlsx(sc2_cornertotalsv2,'GoalTotalsV2.xlsx',sheetName = "SC2", append = TRUE)
# write.xlsx(sc3_cornertotalsv2,'GoalTotalsV2.xlsx',sheetName = "SC3", append = TRUE)
# write.xlsx(sp1_cornertotalsv2,'GoalTotalsV2.xlsx',sheetName = "SP1", append = TRUE)
# write.xlsx(sp2_cornertotalsv2,'GoalTotalsV2.xlsx',sheetName = "SP2", append = TRUE)
# write.xlsx(t1_cornertotalsv2,'GoalTotalsV2.xlsx',sheetName = "T1", append = TRUE)
