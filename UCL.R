...
###############################################################################
df <- tail(UCL[UCL$HomeTeam =="Roma" | UCL$AwayTeam =="Roma",],6)
df2 <- tail(UCL[UCL$HomeTeam == "Sociedad" | UCL$AwayTeam == "Sociedad",],6)
...
write.csv(temp_analysis,'Temp/romasociedad.csv')
