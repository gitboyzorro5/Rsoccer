...
library('lubridate')
allteams20252026 <- read.csv('allteams20252026SOT.csv')

#change date strings to Date objects
allteams20252026$Date <- dmy(allteams20252026$Date)
allteams20252026 <- allteams20252026[order(as.Date(allteams20252026$Date, format = "%d/%m/%Y"), decreasing = FALSE),]
#calculate total goals
allteams20252026$TG <- allteams20252026$FTHG + allteams20252026$FTAG
allteams20252026$TC <- allteams20252026$HCO + allteams20252026$ACO
allteams20252026$TF <- allteams20252026$HF + allteams20252026$AF
allteams20252026$COSC <- paste(allteams20252026$HCO,allteams20252026$ACO,sep = "-")
allteams20252026$OV15 <- ifelse(allteams20252026$TG >= 2,"Y","N")
allteams20252026$OV25 <- ifelse(allteams20252026$TG >= 3,"Y","N")
allteams20252026$OV35 <- ifelse(allteams20252026$TG >= 4,"Y","N")
allteams20252026$TY <- allteams20252026$HY + allteams20252026$AY
allteams20252026$TR <- allteams20252026$HR + allteams20252026$AR

#create divisions subsets
B1 <- subset(allteams20252026, Div == "B1")
D1 <- subset(allteams20252026, Div == "D1")
D2 <- subset(allteams20252026, Div == "D2")
E0 <- subset(allteams20252026, Div == "E0")
E1 <- subset(allteams20252026, Div == "E1")
E2 <- subset(allteams20252026, Div == "E2")
E3 <- subset(allteams20252026, Div == "E3")
EC <- subset(allteams20252026, Div == "EC")
F1 <- subset(allteams20252026, Div == "F1")
F2 <- subset(allteams20252026, Div == "F2")
G1 <- subset(allteams20252026, Div == "G1")
I1 <- subset(allteams20252026, Div == "I1")
I2 <- subset(allteams20252026, Div == "I2")
N1 <- subset(allteams20252026, Div == "N1")
P1 <- subset(allteams20252026, Div == "P1")
SC0 <- subset(allteams20252026, Div == "SC0")
SC1 <- subset(allteams20252026, Div == "SC1")
SC2 <- subset(allteams20252026, Div == "SC2")
SC3 <- subset(allteams20252026, Div == "SC3")
SP1 <- subset(allteams20252026, Div == "SP1")
SP2 <- subset(allteams20252026, Div == "SP2")
T1 <- subset(allteams20252026, Div == "T1")
############################################################
