...
###############################################################################
df <- tail(F1_ucl[F1_ucl$HomeTeam =="Monaco" | F1_ucl$AwayTeam =="Monaco",],6)
df2 <- tail(D1_ucl[D1_ucl$HomeTeam == "Leverkusen" | D1_ucl$AwayTeam == "Leverkusen",],6)
...
write.csv(temp_analysis,'monacolev6.csv')
